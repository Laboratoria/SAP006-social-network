...
const sendPost = () => {
  ...
  // essa é a nossa coleção do firebase. db = database //
...
export const postar = () => {
  rootElement.innerHTML = ` 
    ...
    <nav class="navBar">
     ...
     <div class="addPrice">
      <input type="radio" name="valor" value="baixo/barato"/>
      <input type="radio" name="valor" checked value="médio"/>
      <input type="radio" name="valor" value="alto/caro"/>
     </div>
     <hr>
  ...
  rootElement.querySelector('#sendPost').addEventListener('click', sendPost);
  return rootElement;
};
