...
export const login = () => {
  ...
  <main>
      ...
      <div class="justify-enter">
        <button type="button" name="botao" id="entrar" class="entrar">ENTRAR</button>
      </div>
      <button class="forgetPass" id="forgetPass"> Esqueci a senha! </button>
      <div class="justify-google">
        <button type="button" name="botao" id="google-login" class="google-login"> <img src="./img/google.png" class="google-logo" />Sign in
          with Google</button>
      </div>
      <div class="line">
        <hr>
      ...
      <div class="justify-register">
        <a id="cadastro" href="#" class="cadastro">Cadastre-se</a>
      </div> 
    <main>
    </div>`;
